# -*- coding: utf-8 -*-
#
# remotecontrol documentation build configuration file, created by
...
htmlhelp_basename = 'remotecontroldoc'
...
latex_documents = [
  ('index', 'remotecontrol.tex', u'remotecontrol Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'remotecontrol', u'remotecontrol Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'remotecontrol', u'remotecontrol Documentation',
   u'Western X', 'remotecontrol', 'One line description of project.',
   'Miscellaneous'),
]
